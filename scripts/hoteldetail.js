...
<div class="price1">
    ...
    <strike style="color: #727272;font-size: 14px;" >₹ ${Math.floor(data.dprice+((data.dprice/100)*10))}</strike>
    </div>
    <div class="dit">
    <small style="color: #4a4a4a;font-size: 14px;" ><i class="fa-solid fa-check"></i>Room Only</small>
    <small style="color: #000000;font-size: 22px;font-weight:900" >₹ ${data.dprice}</small>
    </div>
    <div class="dit">
    <small></small>
    <small style="color: #727272;font-size: 12px;font-weight:900" >+ ₹ ${Math.ceil((data.dprice/100)*18)} taxes & fee </small>
    </div>
    <div class="dit">
    <small></small>
    <small style="color: #D0021B;font-size: 12px;" >Saving ₹ ${Math.floor(data.dprice+((data.dprice/100)*10))-data.dprice}</small>
    </div>
    <div class="dit">
